...
export const fingerprint = Joi.string().length(20).required().label('X-Fingerprint')

export const language = Joi.string().default(DEFAULT_LANGUAGE).length(2).label('Accept-Language')
